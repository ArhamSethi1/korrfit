...
export function WhatsAppFloat() {
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-40 inline-flex min-h-11 items-center gap-3 rounded-full border border-[#25D366]/50 bg-surface/90 py-3 pl-3 pr-4 text-sm font-semibold text-foreground shadow-lift backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:border-[#25D366] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366] focus-visible:ring-offset-2 focus-visible:ring-offset-background"
    >
